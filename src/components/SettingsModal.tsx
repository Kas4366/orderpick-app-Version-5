...
import { Settings, X, Upload, FileText, Volume2, Package, Archive, Sliders, Truck, Sheet } from 'lucide-react';
...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'archive' | 'packaging' | 'googlesheets' | 'files' | 'csv' | 'voice' | 'stock' | 'other'>('archive');
